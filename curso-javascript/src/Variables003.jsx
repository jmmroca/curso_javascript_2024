...
import BotonCopiarCodigo from "./components/BotonCopiarCodigo";
    ...
    <>
      ...
      <section id="reglas-para-nombrar-variables-en-javascript">
        ...
        <section id="starts-with-a-letter">
                <BloqueCodigo copySnippet={copySnippet} titulo="1. Las variables deben comenzar con una letra (a-z, A-Z), un signo
              de dólar ($) o un guion bajo (_)" codigo="let edadUsuario = 30; // Empezando correctamente con una letra" />
{/*
          <h4>
            <p>
...
*/}
          ...
          <pre>
            <code className="language-javascript">
              let $edadUsuario = 30; // Empezando correctamente con un signo de
              dólar
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          <pre>
            <code className="language-javascript">
              let _edadUsuario = 30; // Empezando correctamente con un guion
              bajo
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          <pre>
            <code className="language-javascript">
              let edad-usuario = 30; // INCORRECTO: No se debe usar un guion
              medio
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          ...
          <pre>
            <code className="language-javascript">
              let edad usuario = 30; // INCORRECTO: No se debe usar un espacio
        ...
        <section id="cannot-start-with-a-number">
          ...
          <pre>
            <code className="language-javascript">
              let 30edadUsuario = 30; // INCORRECTO: No se puede empezar con un
              número el nombre de una variable
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
        </section>
        <section id="cannot-contain-spaces">
          <h4>
            <p>
              3. Pueden contener letras, números, signos de dólar y guiones
              bajos.
            </p>
          </h4>
          <pre>
        ...
        <section id="cannot-contain-special-characters">
          <h4>
            <p>
              4. No pueden contener espacios ni caracteres especiales como @, #,
              %, etc.
            </p>
          </h4>
          <pre>
            <code className="language-javascript">
              let nie extranjero = 10; // Mal uso; estamos usando un espacio
              entre nie y extranjero
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          <pre>
            <code className="language-javascript">
              let variable- = 10; // Mal uso; estamos usando un guion medio en
              la variable
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          <pre>
            <code className="language-javascript">
              let variable@ = 10; // Mal uso; estamos usando un signo de arroba
              en la variable
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          <pre>
            <code className="language-javascript">
              let variable# = 10; // Mal uso; estamos usando un signo de numeral
              en la variable
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          <pre>
            <code className="language-javascript">
              let variable% = 10; // Mal uso; estamos usando un signo de
        ...
        <section id="case-sensitive">
          <h4>
            <p>
              6. Las variables que se declaran son sensibles a mayúsculas y
              minúsculas.
            </p>
          </h4>
          <pre>
          ...
          <pre>
            <code className="language-javascript">
              let DireccionUsuario = "Calle Falsa 123"; // No es consistente con
              camelCase y es distinta a la variable direccionUsuario
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
          <pre>
      ...
      <section id="restricciones-al-uso-de-las-variables">
        <section id="let-no-duplicate-names">
          ...
          <pre>
            <code className="language-javascript">
              let edadUsuario = 40; // INCORRECTO: repites el nombre de la
              variable
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
        ...
        <section id="const-must-initialize">
          <h4>
            <p>
              2. La palabra reservada const no permite declarar variables sin
              inicializar
            </p>
          </h4>
          <pre>
        ...
        <section id="var-duplicate-names">
          <h4>
            <p>
              3. La palabra reservada var permite declarar variables con el
              mismo nombre
            </p>
          </h4>
          <pre>
        ...
        <section id="var-can-be-uninitialized">
          ...
          <pre>
            <code className="language-javascript">
              // CORRECTO: variable declarada sin inicializar var edadUsuario;
              // Posteriormente se le asigna un valor edadUsuario = 40; // esta
              asignacion es correcta
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
        </section>
        ...
        <section id="let-can-be-uninitialized">
          ...
          <pre>
            <code className="language-javascript">
              // CORRECTO: variable declarada con let sin inicializar let
              edadUsuario; // Posteriormente se le asigna un valor edadUsuario =
              40; // esta asignacion es correcta
            </code>
            <BotonCopiarCodigo copySnippet={copySnippet} />
          </pre>
        </section>
        ...
        <section id="const-no-duplicate-names">
          ...
          <pre>
            <code className="language-javascript">
              // INCORRECTO: nombre de variable repetido; const edadUsuario =
              30; const edadUsuario = 40; // esta asignacion es incorrecta,
